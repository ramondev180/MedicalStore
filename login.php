 ...
 background-color: #ffffff;background-size:cover">
      <div class="row ">
        ...
        <div class="col-sm-6 mt-3">
          <div class="board py-4  px-4  text-center mt-5" style="background:black;color:white">
            <h3>Designed & Developed By : </h3>
            <ul>
              <li class="my-4">Afeez Taofeekat Omotoyosi <br /> CS20200205925</li>
              <li class="my-4">Adeniyi Abdsomod Olayinka <br /> CS20200200742</li>
              <li class="my-4">Osho Sunday Bukola <br /> CS20200204021</li>
            </ul>
