...
--
-- Host: localhost
-- Generation Time: Apr 01, 2023 at 09:49 AM
...
CREATE TABLE `orders` (
  ...
  `delete_status` tinyint(5) NOT NULL DEFAULT 0
...
(1, 'INV-0001', '2022-02-28', 'Jame Mark', '', '2147483647', '', 100, 10, 108, 49, 0, 49, 49, 2, 1, 0, 0),
(2, 'INV-0002', '2022-03-24', 'Moses James', '', '2147483647', '', 300, 0, 354, 0, 0, 354, 354, 3, 3, 1, 0),
(3, 'INV-0003', '2022-04-15', 'Frank Good', '', '2147483647', '', 860, 1015, 10, 1005, 155, 500, 505, 2, 2, 1, 0),
(4, 'INV-0004', '2022-04-15', 'Bola Amed', '', '2147483647', '', 60, 71, 0, 71, 11, 50, 21, 5, 2, 1, 0),
(5, 'INV-0005', '2023-03-31', 'Shola Friday', NULL, '2435678388', NULL, 25, 30, 0, 30, 5, 20, 10, 2, 1, 1, 0);
...
(11, 4, '1', '25', '25.00', 5, '2023-03-31'),
(12, 3, '1', '200', '200.00', 6, '2023-04-01');
...
(5, 'Levothyroxine', '345.jpg', 5, 5, '4', '20', 40, '234', '6733-05-31', '2023-03-31', 2, 2);
