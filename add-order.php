      ...
      <div class="col-lg-11" style="    margin-left: 5%;">
                    ...
                    for ($x = 1; $x < 2; $x++) { ?>
                      <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                        ...
                        <td style="padding-left:20px;">
                          <input type="text" name="rate[]" id="rate<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" required/>
                        ...
                        <td>
                          <input type="text" name="total[]" id="total<?php echo $x; ?>" autocomplete="off" class="form-control" disabled="true" required/>
                          <input type="hidden" name="totalValue[]" id="totalValue<?php echo $x; ?>" autocomplete="off" class="form-control" required/>
                        </td>
                        <td>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue"required />
            </div>

            <label for="totalAmount" class="col-sm-2 control-label">Total Amount</label>
            <div class="col-sm-4">
              <input type="text" class="form-control" id="totalAmount" name="totalAmount" disabled="true" />
              <input type="hidden" class="form-control" id="totalAmountValue" name="totalAmountValue" required/>
            </div>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="grandTotal" name="grandTotal" disabled="true" required/>
              <input type="hidden" class="form-control" id="grandTotalValue" name="grandTotalValue" required/>
            </div>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="vat" name="gstn" readonly="true" required />
              <input type="hidden" class="form-control" id="vatValue" name="vatValue" required/>
            </div>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="due" name="due" disabled="true" required/>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentPlace" id="paymentPlace" required>
                <option value="">~~SELECT~~</option>
                <option value="1">In Nigeria</option>
                <option value="2">Out Of Nigeria</option>
              </select>
            </div>
          </div>
        </div>
